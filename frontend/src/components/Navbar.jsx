        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            <button 
              ...
              className="p-2 md:p-2.5 text-white bg-gradient-to-r from-green-500 to-emerald-600 rounded-full shadow-lg shadow-green-900/20 active:scale-95 transition-all"
            >
              <User size={20} />
            </button>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-3 w-48 bg-[#1a3a5f] border border-white/10 rounded-2xl shadow-2xl py-2 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right">
                ...
                <button onClick={() => setIsProfileOpen(false)} className="w-full flex items-center gap-3 px-4 py-3 text-red-400 hover:bg-red-500/10 text-sm font-bold transition-all">
      ...
      <div className={`lg:hidden fixed inset-0 z-[100] transition-all duration-500 ${isMenuOpen ? "visible" : "invisible"}`}>
        ...
        <div className={`absolute top-0 left-0 bottom-0 w-[280px] bg-[#1a3a5f] shadow-2xl transition-transform duration-500 transform ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
          ...
          <div className="flex flex-col gap-1 p-4">
            ...
            <button onClick={() => setIsMenuOpen(false)} className="flex items-center gap-4 p-4 text-red-400 font-bold hover:bg-red-500/10 rounded-2xl w-full mt-auto">
